      <h1 class="center">UPDATE CUSTOMERS</h1><br><br>
...
<form method="post" enctype="multipart/form-data">
    ...
    <input type="text" name="email" style="border-radius: 20px; height: 30px; width: 270px; text-align: center;" value="<?php echo $pecah['email']; ?>">
     ...
     <div class="center">
    <input type="text" name="alamat" style="border-radius: 20px; height: 30px; width: 270px; text-align: center;" value="<?php echo $pecah['alamat']; ?>">
     </div><br>
     <div class="center">
  ...
  if (isset($_POST['ubah']))
  {
    $koneksi->query("UPDATE pelanggan SET nama='$_POST[nama]', email='$_POST[email]', 
      alamat='$_POST[alamat]', password='$_POST[password]' WHERE id_pelanggan='$_GET[id]' ");
