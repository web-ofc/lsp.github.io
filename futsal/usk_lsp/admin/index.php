    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
            <ul class="navbar-nav mt-2 mt-lg-0 ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="index.php?halaman=menu">Data Menu</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="index.php?halaman=history">History</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="index.php?halaman=kasir">Data Kasir</a>
                </li>
                <li class="nav-item">
