           ...
           <div class="container-fluid mx-5" style="margin:0 140px !important;">
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel" >
                    ...
                    <div class="offcanvas-body">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="index.php?halaman=datamenu">Menu Lawson Station</a>
                        </li> 
                        <li class="nav-item">
                            <a class="nav-link" href="index.php?halaman=kantor_pusat">Daftar Kantor Pusat</a>
                        </li> 
                        <li class="nav-item">
                            <a class="nav-link" href="index.php?halaman=datatransaksi">History</a>
                        </li> 
                        <li class="nav-item">
                            <a class="nav-link" href="index.php?halaman=cumtomer">Data Cumtomer</a>
                        </li> 
                        <li class="nav-item">
