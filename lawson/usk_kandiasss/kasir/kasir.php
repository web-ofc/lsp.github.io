<h1 class="text-center mt-5">DATA KASIR</h1><br><br>
        ...
        <tbody>
            <?php
                if (isset($_POST['cari'])) {
                    ...
                    $ambil = $koneksi->query("SELECT * FROM kasir WHERE nama LIKE '%$keyword%' OR username LIKE '%$keyword%'");
...
<?php 
    ...
    {
        $koneksi->query("INSERT INTO kasir (username,password,nama) VALUES ('$_POST[username]','$_POST[password]','$_POST[nama]')");
    ...
    if (isset($_POST['ubah'])) {
        ...
        $query = "UPDATE kasir SET nama='$nama_baru',username='$username_baru' WHERE id_kasir='$id_kasir'";
