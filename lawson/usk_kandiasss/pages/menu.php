...
<section>
      <div class="text-center container py-5">
         ...
         <nav style="margin-top: 100px;margin-bottom:50px">
            ...
            <h5 class="mt-4 mb-2 text-white text-start" id="seafood"> - Seafood - </h5>
            <div class="row">
            ...
            <h5 class="mt-4 mb-2 text-white text-start" id="meat"> - Meat - </h5>
            <div class="row">
             ...
             <h5 class="mt-4 mb-2 text-white text-start" id="noodles"> - Noodles - </h5>
            <div class="row">
              ...
              <h5 class="mt-4 mb-2 text-white text-start" id="drinks"> - Drinks - </h5>
            <div class="row ">
